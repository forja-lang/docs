/* @ts-self-types="./forja_wasm_gui.d.ts" */
 ...
 * @returns {string}
 */
export function ejecutar_gui(canvas_id, codigo) {
    let deferred3_0;
    let deferred3_1;
    try {
        ...
        const ptr1 = passStringToWasm0(codigo, wasm.__wbindgen_export, wasm.__wbindgen_export2);
        const len1 = WASM_VECTOR_LEN;
        wasm.ejecutar_gui(retptr, ptr0, len0, ptr1, len1);
 ...
 * @returns {string}
 */
export function renderizar(canvas_id, codigo) {
    let deferred3_0;
    let deferred3_1;
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        ...
        const ptr1 = passStringToWasm0(codigo, wasm.__wbindgen_export, wasm.__wbindgen_export2);
        const len1 = WASM_VECTOR_LEN;
        wasm.renderizar(retptr, ptr0, len0, ptr1, len1);
        var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
        var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
        deferred3_0 = r0;
        deferred3_1 = r1;
 ...
 * @returns {string}
 */
export function rerenderizar(canvas_id) {
    let deferred2_0;
    let deferred2_1;
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        const ptr0 = passStringToWasm0(canvas_id, wasm.__wbindgen_export, wasm.__wbindgen_export2);
        const len0 = WASM_VECTOR_LEN;
        wasm.rerenderizar(retptr, ptr0, len0);
        var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
        var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
        deferred2_0 = r0;
        deferred2_1 = r1;
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('forja_wasm_gui_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
